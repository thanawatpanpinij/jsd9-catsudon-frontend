...
const Header = () => {
  ...
  const { cartRef, mobileCartRef, handleClickCart } =
  ...
  const icons = [
    ...
    {
      icon: <RiHeartFill className="text-xl" />,
      count: 0,
      ref: mobileFavRef,
            ...
            <div className="hidden min-[969px]:flex items-center gap-5">
              ...
              {!userInfo ? (
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 flex items-center justify-center rounded-full text-slate-700 font-medium bg-primary-background">
                    {getInitials(
            ...
            <ul className="flex flex-col items-start gap-5 mt-5 mx-[32px] text-white text-small-size">
              {userInfo && (
                <div className="flex items-center gap-4 mb-3">
                  <div className="text-[18px] w-12 h-12 flex items-center justify-center rounded-full text-slate-700 font-medium bg-primary-background">
                    {getInitials(
                      `${userInfo.firstName} ${userInfo?.lastName || ""}`
                    )}
                  </div>
