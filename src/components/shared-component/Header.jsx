...
const Header = () => {
    ...
    return (
        <>
            <div
                className={`sticky top-0 z-[200] bg-white transition-shadow duration-300 ${showShadow ? "shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)]" : ""
                    }`}
            >
                <TextScroller />
                {/* NavBar */}
              ...
              ${dropdownOpen ? "rotate-180" : "rotate-0"}`}
                    ...
                    {/* ------------------------ Mobile Menu ------------------------ */}
                    <div
                        className={`hidden max-[968px]:block ${showMobileMenu ? "fixed w-[60%]" : "h-0 w-0"
