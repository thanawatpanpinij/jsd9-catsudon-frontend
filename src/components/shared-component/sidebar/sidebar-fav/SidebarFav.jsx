  ...
  return (
    <aside
      ...
      className={`z-200 fixed top-[100.44px] ${
        showSidebarFav ? "opacity-100 right-0 animate-[slide-in_0.4s_cubic-bezier(0.4,0,0.2,1)]" : "opacity-0 right-[-483px] animate-[slide-out_0.4s_cubic-bezier(0.4,0,0.2,1)]"
    ...
    >
      <section className="flex flex-col overflow-hidden mb-8">
        <div className="flex justify-between items-end text-grey font-semibold">
          <p className={`text-third text-medium-size transition-colors duration-200`}>My favorites</p>
