  ...
  const users = [
    {
      ...
      imageUrl:
        "https://res.cloudinary.com/dsgtmtcmt/image/upload/v1744720542/001-user_qjnijn.jpg",
    ...
    },
    {
      ...
      imageUrl:
        "https://res.cloudinary.com/dsgtmtcmt/image/upload/v1744720545/004-user_kfpir5.webp",
    ...
    >
      <section>
        <div className="flex gap-2 items-center mb-4">
          ...
          <h2 className="text-medium-size text-third font-semibold">
            Comments
          </h2>
          <span className="px-2 py-[2px] text-small-size text-[#4A4A4A] bg-bright-grey rounded-full">
            {users.length}
          </span>
        </div>
        <section
